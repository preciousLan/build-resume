            ...
            <footer className="flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500 bg-linear-to-r from-white via-green-200/60 to white  mt-40">
                ...
                <div className="flex flex-col max-md:items-center max-md:text-center gap-2 items-end">
                    ...
                    <div className="flex items-center gap-4 mt-3">
                        <Link href="https://dribbble.com/prebuiltui" target="_blank" rel="noreferrer">
                        ...
                        <Link href="https://www.linkedin.com/company/prebuiltui" target="_blank" rel="noreferrer">
                        ...
                        <Link href="https://x.com/prebuiltui" target="_blank" rel="noreferrer">
                        ...
                        <Link href="https://www.youtube.com/@prebuiltui" target="_blank" rel="noreferrer">
                    ...
                    <p className="mt-3 text-center">© 2025 <Link href="https://prebuiltui.com">PrebuiltUI</Link></p>
                </div>
            </footer>
        </>
    )
