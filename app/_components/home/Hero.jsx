    ...
    return (
        <>
            <div className="min-h-screen pb-20">
                ...
                <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
                    ...
                    <div className="flex items-center mt-24">
                        <div className="flex -space-x-3 pr-3">
                            <Image src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?q=80&w=200" alt="user3" width={32} height={32} className="size-8 object-cover rounded-full border-2 border-white hover:-translate-y-0.5 transition  z-[1]" />
                            <Image src="https://images.unsplash.com/photo-1633332755192-727a05c4013d?q=80&w=200" alt="user1" width={32} height={32} className="size-8 object-cover rounded-full border-2 border-white hover:-translate-y-0.5 transition z-2" />
                            <Image src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?q=80&w=200" alt="user2" width={32} height={32} className="size-8 object-cover rounded-full border-2 border-white hover:-translate-y-0.5 transition z-[3]" />
                            <Image src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?q=80&w=200" alt="user3" width={32} height={32} className="size-8 object-cover rounded-full border-2 border-white hover:-translate-y-0.5 transition z-[4]" />
                            <Image src="https://randomuser.me/api/portraits/men/75.jpg" alt="user5" width={10} height={10} className="size-8 rounded-full border-2 border-white hover:-translate-y-0.5 transition z-[5]" />
                        </div>
                    ...
                    <div className="flex items-center gap-4 ">
                        <Link href='/app' className="bg-green-500 hover:bg-green-600 text-white rounded-full px-9 h-12 m-1 ring-offset-5 ring-1 ring-green-700 flex items-center transition-colors">
                            Get started
                ...
                {/* <div className="absolute -z-50 size-100 top-10 left-20 aspect-square rounded-full bg-indigo-500/20 blur-3xl"></div> */}
